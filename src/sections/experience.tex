...
{\textbf{Leveraged skills}: AWS, Python, SQL, DBT, Docker, Dagster, Snowflake, Terraform, GH Action } % Leveraged skills
{
...
% %---------------------------------------------------------
  \cventry
  {Data Scientist} % Job title
  {BearingPoint} % Company
  {Technology consultancy} % company details
  {Paris, FR} % Location
  {12.2019} % beginDate(s)
  {06.2020} % endDate(s)
  {Company size: 5000+ | One of 3 Consultants for this mission} %team-size 
  {\textbf{Leveraged skills}: AWS, Python, SQL, Scikit-Learn} % Leveraged skills
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
