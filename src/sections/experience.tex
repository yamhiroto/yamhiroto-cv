...
{\textbf{Leveraged skills}: AWS, Python, SQL, DBT, Docker, Dagster, Redshift, Snowflake, Terraform, ECS, Airbyte, Github Action, PDM, Make } % Leveraged skills
{
  \begin{cvitems} % Description(s) of tasks/responsibilities
    % \item {Actively participating in the infrastructure merge plan design of two acquired companies}
